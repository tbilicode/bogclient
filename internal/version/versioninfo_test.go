...
func TestInfo_GreaterOrEqual(t *testing.T) {
	v01 := Info{0, 1, 3, "", "go1.5", float32(1.3)}
	v02 := Info{0, 2, 3, "", "go1.5", float32(102.3)}
	v10 := Info{1, 0, 30, "", "go1.5", float32(100.30)}
	v12 := Info{1, 2, 31234, "", "go1.5", float32(102.31234)}
	v20 := Info{2, 19, 2312234, "", "go1.5", float32(219.2312234)}
